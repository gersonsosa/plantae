...
public class SpecimenListFragment extends ListFragment implements View.OnClickListener{
    ...
    public static final String[] csvHeader = {"Numero Colección", "Fecha inicial recolección", "Fecha final recolección", 
        "Método de colección", "Estación del año", "Colectores Secundarios", 
        "Nombre localidad", "Municipio", "Departamento", "Pais", "Elevación mínima", 
        "Elevación máxima", "Latitud", "Longitud", "Descripción localidad", "Familia", 
        ...
        "RGB color de la corola", "Munsell color de la corola", 
        "Nombre color del caliz", "Descripción color del caliz", 
        "RGB color del caliz", "Munsell color del caliz", 
        "Nombre color del gineceo", "Descripción color del gineceo", 
        "RGB color del gineceo", "Munsell color del gineceo", 
        "Nombre color de los estambres", "Descripción color de los estambres", 
        "RGB color de los estambres", "Munsell color de los estambres", 
        "Nombre color de los estigmas", "Descripción color de los estigmas", 
        "RGB color de los estigmas", "Munsell color de los estigmas", 
        "Nombre color de los pistiliodios", "Descripción color de los pistiliodios", 
        "RGB color de los pistiliodios", "Munsell color de los pistiliodios", 
        "Descripción fruto", "Consistencia del pericarpio", "Nombre color del exocarpio", 
        "Descripción color del exocarpio", "RGB color del exocarpio", 
        "Munsell color del exocarpio", "Nombre color del mesocarpio", 
        "Descripción color del mesocarpio", "RGB color del mesocarpio", 
        "Munsell color del mesocarpio", "Nombre color del exocarpio inmaduro", 
        "Descripción color del exocarpio inmaduro", "RGB color del exocarpio inmaduro", 
        "Munsell color del exocarpio inmaduro", "Nombre color del mesocarpio inmaduro", 
        "Descripción color del mesocarpio inmaduro", "RGB color del mesocarpio inmaduro", 
        "Munsell color del mesocarpio inmaduro", "Descripción inflorescencia", 
        "Naturaleza de las bracteas pedunculares", "Naturaleza del profilo", 
        "Posicion de las bracteas pedunculares", "Posicion de las inflorescencias", 
        "Raquilas", "Raquis", "Tamaño de las bracteas pedunculares", 
        "Tamaño del pedunculo", "Tamaño del profilo", "Tamaño del raquis", 
        "Tamaño de raquilas", "Nombre color de la inflorescencia en flor", 
        "Descripción color de la inflorescencia en flor", 
        "RGB color de la inflorescencia en flor", 
        "Munsell color de la inflorescencia en flor", 
        "Nombre color de la inflorescencia en fruto", 
        "Descripción color de la inflorescencia en fruto", 
        "RGB color de la inflorescencia en fruto", 
        "Munsell color de la inflorescencia en fruto", "Descripción raiz", 
        "Diametro de las raices", "Diametro en la base", "Forma de las espinas", 
        "Tamaño de las espinas", "Raiz armada", "Altura del cono", 
        "Nombre color del cono", "Descripción color del cono", "RGB color del cono", 
        "Munsell color del cono", "Descripcion de la hoja", "Cobertura del peciolo", 
        "Dispocicion de las pinnas", "Disposicion de las hojas", "Forma del peciolo", 
        "Longuitud del raquis", "Naturaleza de la vaina", "Naturaleza del limbo", 
        "Numero de pinnas", "Numero hojas", "Tamaño de la vaina", 
        "Tamaño del peciolo", "Nombre color de la vaina", 
        "Descripción color de la vaina", "RGB color de la vaina", 
        "Munsell color de la vaina", "Nombre color del peciolo", 
        "Descripción color del peciolo", "RGB color del peciolo", 
        "Munsell color del peciolo", "Descripción tallo", "Desnudo cubierto", 
        "Entrenudos conspicuos", "Espinas", "Nombre color del tallo", 
        "Descripción color del tallo", "RGB color del tallo", "Munsell color del tallo"};
    ...
    class ExportCSVTask extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            exportDir = new File(Environment.getExternalStorageDirectory() + "/Plantae/csv");
