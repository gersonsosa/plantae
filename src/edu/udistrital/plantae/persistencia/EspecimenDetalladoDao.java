...
public class EspecimenDetalladoDao {
	
	public EspecimenDetalladoDao() {
	}
	
	protected void bindValues(SQLiteStatement stmt, EspecimenDetallado entity) {
        ...
        stmt.bindString(19, "ED");
    }
	
	public Especimen readEntity(Cursor cursor, int offset) {
        EspecimenDetallado entity = new EspecimenDetallado();
        readEntity(cursor, entity, offset);
        return entity;
    }

    public void readEntity(Cursor cursor, EspecimenDetallado entity, int offset) {
